    ...
    <section className="relative w-full min-h-[85vh] md:min-h-screen 2xl:min-h-[85vh] flex flex-col items-center justify-center px-6 overflow-hidden bg-black pt-20" id="work">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-200 mx-auto">
        ...
        <p className="font-display font-normal text-[#a1a1a1] text-sm md:text-base 2xl:text-xl leading-relaxed md:max-w-140 mx-auto mb-10">
          OffLayout is a product lab focused on execution, designing and building
          Web2 and Web3 products that are ready to launch.
        </p>

        {/* Action Button */}
        <button onClick={openModal} className="cursor-pointer flex items-center gap-2 bg-white text-black px-3 py-3 rounded-full text-sm md:text-[15px] 2xl:text-base font-display font-medium hover:bg-gray-200 transition-colors">
