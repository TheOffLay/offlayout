      ...
      <footer className="max-w-280 2xl:max-w-318 mx-auto px-4 lg:px-6 mt-8 md:mt-16">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-8 md:space-y-0">
          <span className="space-y-2">
            <p className="font-display font-normal text-sm md:text-base">Clients</p>
            <a
              href="https://zernx.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <p className="text-[#B3B3B3] hover:text-white font-display font-normal text-sm md:text-base mb-1">
                ZernX
              </p>
            </a>
            <div className="flex items-center gap-2 mb-1">
              <p className="text-[#B3B3B3] hover:text-white font-display font-normal text-sm md:text-base">
                Splixor
              </p>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-16 space-y-8 md:space-y-0">
            ...
            <span className="space-y-2">
              <p className="font-display font-normal text-sm md:text-base">Connect</p>
              <a href="mailto:offlayout@gmail.com">
                <p className="text-[#B3B3B3] hover:text-white font-display font-normal text-sm md:text-base transition-colors duration-200 mb-1">
                  Email
                </p>
              </a>
