...
export default function Consult() {
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSelectedBudget(""); // Reset the custom dropdown
      } else {
        setStatus("error");
      }
    } catch (error) {
  ...
  return (
    <>
      {/* NORMAL PAGE FORM */}
      <div className="w-full min-h-screen flex items-center justify-center bg-black p-4 py-12 md:p-8">
        <div className="relative w-full max-w-99 lg:max-w-150 mx-auto py-8 md:py-10 rounded-2xl">
      ...
      {status === "success" && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="relative overflow-hidden flex flex-col items-center justify-center text-center py-12 px-5 animate-in zoom-in-95 duration-300 w-full max-w-[552px] bg-[#171717] border border-[#1E1E1E] rounded-2xl shadow-2xl">
